...
var grammar = {
    ...
    {"name": "class_extention_definition", "symbols": ["__", "access_specifier", "__", (lexer.has("literal") ? {type: "literal"} : literal), "_", "class_extention_definition"], "postprocess": function([ws0,access_spec,ws1,name, ws, recurse]) {return [{access: access_spec, name:name.value}, ...recurse]}},
    {"name": "class_extention_definition", "symbols": ["__", (lexer.has("literal") ? {type: "literal"} : literal), "_", "class_extention_definition"], "postprocess": function([ws0,name,ws1, recurse]) {return [{access: "default", name:name.value},...recurse]}},
